In this project, I will be building a small version of what is called a relational database management system (DBMS), as well as a DSL (Domain Specific Language) with which a user can interact with your database. The language Iwill be implementing is similar to the declarative programming language SQL, which is used in the real world to interact with and query databases, large or small. 
...
Detailed project specifications can be found here: http://datastructur.es/sp17/materials/proj/proj2/proj2.html#table-of-contents
